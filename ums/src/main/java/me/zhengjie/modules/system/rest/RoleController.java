...
public class RoleController {
  ...
  public ResponseEntity getLevel() {
    //        List<Integer> levels =
    // roleService.findByUsers_Id(SecurityUtils.getUserId()).stream().map(RoleSmallDTO::getLevel).collect(Collectors.toList());
  ...
  public ResponseEntity delete(@PathVariable Long id) {
    try {
      ...
      ThrowableUtil.throwForeignKeyException(
          e, "This role has connection with some user, you should revoke that before you delete.");
    }
